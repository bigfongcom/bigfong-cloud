package com.bigfong.cloud.serviceproduct.config;

import com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceBuilder;
import com.baomidou.mybatisplus.extension.plugins.PaginationInterceptor;
import com.baomidou.mybatisplus.extension.plugins.PerformanceInterceptor;
import com.bigfong.cloud.serviceproduct.common.DBTypeEnum;
import com.bigfong.cloud.serviceproduct.common.DynamicDataSource;
...
public class MybatisPlusConfig {
    ...
    public DataSource multipleDataSource (@Qualifier("basic") DataSource basic,
        ...
        dynamicDataSource.setDefaultTargetDataSource(product);
