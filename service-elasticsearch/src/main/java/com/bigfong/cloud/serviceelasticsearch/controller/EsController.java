package com.bigfong.cloud.serviceelasticsearch.controller;

import com.alibaba.fastjson.JSONObject;
import com.bigfong.cloud.serviceelasticsearch.entity.basic.EsModel;
import com.bigfong.cloud.serviceelasticsearch.entity.basic.EsPage;
import com.bigfong.cloud.serviceelasticsearch.utils.ElasticsearchUtil;
...
public class EsController {
    ...
    /**
     * http://127.0.0.1:8907/es/createIndex
     * 创建索引
     *
     * @param request
     * @param response
    ...
    /**
     * 获取数据
     * http://127.0.0.1:8907/es/getData?id=2018-04-25%2016:33:44
     *
     * @param id
     * @return
     */
     ...
     *                  从0开始
     *                  第1页 ：http://127.0.0.1:8907/es/queryPage?startPage=0&pageSize=2
     *                  第2页 ：http://127.0.0.1:8907/es/queryPage?startPage=2&pageSize=2
     * @param pageSize  每页大小
     * @return
     */
