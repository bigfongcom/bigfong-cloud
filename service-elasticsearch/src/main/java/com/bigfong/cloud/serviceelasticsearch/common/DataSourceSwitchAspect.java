package com.bigfong.cloud.serviceelasticsearch.common;
...
public class DataSourceSwitchAspect {
    ...
    @Pointcut("execution(* com.bigfong.cloud.serviceelasticsearch.service.basic..*.*(..))")
    private void basicAspect() {
    }

    @Pointcut("execution(* com.bigfong.cloud.serviceelasticsearch.service.product..*.*(..))")
